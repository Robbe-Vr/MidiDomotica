...
namespace MidiDomotica.MidiConnection.Event
{
    internal partial class Events
    {
        private void onTimerElapsedMode7(object sender, ElapsedEventArgs e)
        {
            ...
            if (lastNote != null)
            {
                object key = Mode7NoteHeldEventKey;
        ...
        internal void NotePressedMode7(MidiMessageRecievedEventArgs e)
        {
            SetMode(7);
            ...
            {
                object key = Mode7NoteOnDoubleClickEventKey;
            ...
            else
            {
                ...
                object key = Mode7NoteOnEventKey;
        ...
        private void NoteReleasedMode7(MidiMessageRecievedEventArgs e)
        {
            ...
            {
                object key = Mode7NoteOffDelayedEventKey;
            ...
            else
            {
                ...
                if (note != null)
                {
                    ...
                    {
                        object key = Mode7NoteOffDoubleClickEventKey;
                ...
                {
                    object key = Mode7NoteOffEventKey;
