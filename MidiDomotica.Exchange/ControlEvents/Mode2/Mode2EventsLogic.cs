...
namespace MidiDomotica.MidiConnection.Event
{
    internal partial class Events
    {
        private void onTimerElapsedMode2(object sender, ElapsedEventArgs e)
        {
            ...
            if (lastNote != null)
            {
                object key = Mode2NoteHeldEventKey;
        ...
        private void NotePressedMode2(MidiMessageRecievedEventArgs e)
        {
            ...
            {
                object key = Mode2NoteOnDoubleClickEventKey;
            ...
            else
            {
                ...
                object key = Mode2NoteOnEventKey;
        ...
        private void NoteReleasedMode2(MidiMessageRecievedEventArgs e)
        {
            ...
            {
                object key = Mode2NoteOffDelayedEventKey;
            ...
            else
            {
                ...
                if (note != null)
                {
                    ...
                    {
                        object key = Mode2NoteOffDoubleClickEventKey;
                ...
                {
                    object key = Mode2NoteOffEventKey;
