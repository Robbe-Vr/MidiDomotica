...
namespace MidiDomotica.MidiConnection.Event
{
    internal partial class Events
    {
        private void onTimerElapsedMode1(object sender, ElapsedEventArgs e)
        {
            ...
            if (lastNote != null)
            {
                object key = Mode1NoteHeldEventKey;
        ...
        internal void NotePressedMode1(MidiMessageRecievedEventArgs e)
        {
            SetMode(1);
            ...
            {
                ((EventHandler<OnNoteOnEventArgs>)listEventDelegates[Mode1NoteOnDoubleClickEventKey])?.Invoke(this, new OnNoteOnEventArgs()
                {
                    DeviceName = "Novation SL MK3",
            ...
            {
                object key = Mode1NoteOnEventKey;
        ...
        private void NoteReleasedMode1(MidiMessageRecievedEventArgs e)
        {
            ...
            {
                object key = Mode1NoteOffDelayedEventKey;
            ...
            else
            {
                ...
                {
                    ((EventHandler<OnNoteOffEventArgs>)listEventDelegates[Mode1NoteOffDoubleClickEventKey])?.Invoke(this, new OnNoteOffEventArgs()
                    {
                        DeviceName = "Novation SL MK3",
                        Note = NoteForIndex(e.Message.Data1).ToString(),
                        NoteIndex = e.Message.Data1,
                ...
                {
                    object key = Mode1NoteOffEventKey;
