...
namespace MidiDomotica.MidiConnection.Event
{
    internal partial class Events
    {
        private void onTimerElapsedMode4(object sender, ElapsedEventArgs e)
        {
            ...
            if (lastNote != null)
            {
                object key = Mode4NoteHeldEventKey;
        ...
        private void NotePressedMode4(MidiMessageRecievedEventArgs e)
        {
            ...
            {
                object key = Mode4NoteOnDoubleClickEventKey;
            ...
            else
            {
                ...
                object key = Mode4NoteOnEventKey;
        ...
        private void NoteReleasedMode4(MidiMessageRecievedEventArgs e)
        {
            ...
            {
                object key = Mode4NoteOffDelayedEventKey;
            ...
            else
            {
                ...
                if (note != null)
                {
                    ...
                    {
                        object key = Mode4NoteOffDoubleClickEventKey;
                ...
                {
                    object key = Mode4NoteOffEventKey;
