...
namespace MidiDomotica.MidiConnection.Event
{
    internal partial class Events
    {
        private void onTimerElapsedMode8(object sender, ElapsedEventArgs e)
        {
            ...
            if (lastNote != null)
            {
                object key = Mode8NoteHeldEventKey;
        ...
        internal void NotePressedMode8(MidiMessageRecievedEventArgs e)
        {
            SetMode(8);
            ...
            {
                object key = Mode8NoteOnDoubleClickEventKey;
            ...
            else
            {
                ...
                object key = Mode8NoteOnEventKey;
        ...
        private void NoteReleasedMode8(MidiMessageRecievedEventArgs e)
        {
            ...
            {
                object key = Mode8NoteOffDelayedEventKey;
            ...
            else
            {
                ...
                if (note != null)
                {
                    ...
                    {
                        object key = Mode8NoteOffDoubleClickEventKey;
                ...
                {
                    object key = Mode8NoteOffEventKey;
