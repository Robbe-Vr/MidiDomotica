...
namespace MidiDomotica.MidiConnection.Events
{
    public partial class EventsMapper
    {
        private void onTimerElapsedMode3(object sender, ElapsedEventArgs e)
        {
            ...
            if (lastNote != null)
            {
                object key = this[$"Mode3_{lastNote.Note}_{lastNote.NoteIndex}_NoteHeldEventKey"];
        ...
        private void NotePressedMode3(MidiMessageRecievedEventArgs e)
        {
            ...
            {
                object key = this[$"Mode3_{noteName}_{noteIndex}_NoteOnDoubleClickEventKey"];
            ...
            else
            {
                ...
                object key = this[$"Mode3_{noteName}_{noteIndex}_NoteOnEventKey"];
        ...
        private void NoteReleasedMode3(MidiMessageRecievedEventArgs e)
        {
            ...
            {
                object key = this[$"Mode3_{noteName}_{noteIndex}_NoteOffDelayedEventKey"];
            ...
            else
            {
                ...
                if (note != null)
                {
                    ...
                    {
                        object key = this[$"Mode3_{noteName}_{noteIndex}_NoteOffDoubleClickEventKey"];
                ...
                {
                    object key = this[$"Mode3_{noteName}_{noteIndex}_NoteOffEventKey"];
