...
namespace MidiDomotica.MidiConnection.Events
{
    public partial class EventsMapper
    {
        private void onTimerElapsedMode5(object sender, ElapsedEventArgs e)
        {
            ...
            if (lastNote != null)
            {
                object key = this[$"Mode5_{lastNote.Note}_{lastNote.NoteIndex}_NoteHeldEventKey"];
        ...
        public void NotePressedMode5(MidiMessageRecievedEventArgs e)
        {
            SetMode(5);
            ...
            {
                object key = this[$"Mode5_{noteName}_{noteIndex}_NoteOnDoubleClickEventKey"];
            ...
            else
            {
                ...
                object key = this[$"Mode5_{noteName}_{noteIndex}_NoteOnEventKey"];
        ...
        private void NoteReleasedMode5(MidiMessageRecievedEventArgs e)
        {
            ...
            {
                object key = this[$"Mode5_{noteName}_{noteIndex}_NoteOffDelayedEventKey"];
            ...
            else
            {
                ...
                if (note != null)
                {
                    ...
                    {
                        object key = this[$"Mode5_{noteName}_{noteIndex}_NoteOffDoubleClickEventKey"];
                ...
                {
                    object key = this[$"Mode5_{noteName}_{noteIndex}_NoteOffEventKey"];
